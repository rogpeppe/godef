...
// If an Image implements the DrawMasker interface, then its DrawMask method
// will be called when it is the destination of a Draw operation.
// DrawMask should return true if the operation has been performed.
